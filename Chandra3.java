import java.util.*;
public class Chandra3 {

        private int x, y, z;
        private String direction;

        public Chandra3(int x, int y, int z, String direction) {
            this.x = x;
            this.y = y;
            this.z = z;
        ...
        public static void main(String[] args) {
         ...
         //   String[] commands = {"f", "r", "u", "b", "l"};
            ...
            Chandra3 spacecraft = new Chandra3(startingPosition[0], startingPosition[1], startingPosition[2], initialDirection);
            while(true) {
